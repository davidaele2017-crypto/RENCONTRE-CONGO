...
async function initSchema() {
  await pool.query(`
    ...
    -- Un blocage coupe les effets dans les deux sens (plus visible en
    -- découverte, plus dans "qui m'a liké", conversation fermée, appels
    -- refusés) même si un seul des deux comptes a initié le blocage.
    ...
    -- Un compte peut avoir plusieurs abonnements (plusieurs appareils/navigateurs
    -- installés) — endpoint est l'identifiant unique fourni par le navigateur.
