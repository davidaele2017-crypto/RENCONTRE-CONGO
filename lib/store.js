...
function createOrder(data, userId, planId, amount, currency) {
  const order = {
    id: id(),
...
function getOrderByTransactionId(data, transactionId) {
  return data.orders.find(o => o.transactionId === transactionId);
}

function markOrderStatus(data, transactionId, status) {
